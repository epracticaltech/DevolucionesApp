...
-- Seed de 10 Solicitudes repartidas en los 6 estados con referencias bancarias e historiales coherentes
...
('DEV-2026-000002', '11111111-1', 'CARLOS GONZALEZ', 450000.00, 'CLP', 'BCI', '99887766', 'REF-SEED-002', 'MANUAL', 'BORRADOR', 'Inconsistencia en comprobante de transferencia', 1, 'analista1', 'analista1'),
...
('DEV-2026-000006', '16666666-2', 'RODRIGO VAZQUEZ', 75000.00, 'CLP', 'ITAÚ', '66778899', 'REF-SEED-006', 'MANUAL', 'APROBADA', NULL, 0, 'analista1', 'supervisor1'),
...
('DEV-2026-000009', '19999999-7', 'LORETO BRAVO SANCHEZ', 850000.00, 'CLP', 'SANTANDER', '44556677', 'REF-SEED-009', 'MANUAL', 'PAGADA', NULL, 0, 'analista1', 'supervisor1'),
...
-- Solicitud 2: BORRADOR (reabierta)
(2, NULL, 'BORRADOR', 'analista1', 'Creación manual de solicitud de devolución'),
(2, 'BORRADOR', 'EN_REVISION', 'analista1', 'Enviado a revisión del supervisor'),
(2, 'EN_REVISION', 'RECHAZADA', 'supervisor1', 'Rechazado: Inconsistencia en comprobante de transferencia'),
(2, 'RECHAZADA', 'BORRADOR', 'analista1', 'Solicitud reabierta para corrección de antecedentes (Intento 1/1)'),
...
-- Solicitud 6: APROBADA
(6, NULL, 'BORRADOR', 'analista1', 'Creación manual de solicitud de devolución'),
(6, 'BORRADOR', 'EN_REVISION', 'analista1', 'Enviado a revisión del supervisor'),
(6, 'EN_REVISION', 'APROBADA', 'supervisor1', 'Solicitud aprobada por el supervisor'),
...
-- Solicitud 9: PAGADA
(9, NULL, 'BORRADOR', 'analista1', 'Creación manual de solicitud de devolución'),
(9, 'BORRADOR', 'EN_REVISION', 'analista1', 'Enviado a revisión del supervisor'),
(9, 'EN_REVISION', 'APROBADA', 'supervisor1', 'Solicitud aprobada por el supervisor'),
(9, 'APROBADA', 'PAGADA', 'supervisor1', 'Pago de la devolución efectuado exitosamente'),
